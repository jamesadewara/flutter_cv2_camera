...
String getLibraryPath() {
  ...
  final debugBundleLib = path.join(
  ...
  throw Exception(
    'Could not find flutter_cv2_camera_plugin library in any expected location for ${Platform.operatingSystem}',
  );
}
  ...
  if (Platform.isLinux) {
    ...
    try {
      return DynamicLibrary.open(
        'flutter_cv2_camera_plugin.framework/flutter_cv2_camera_plugin',
      );
    } catch (e) {
      return DynamicLibrary.open(getLibraryPath());
    }
